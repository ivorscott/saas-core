...
func (_m *DataStorer) BeginTxx(ctx context.Context, opts *sql.TxOptions) (*sqlx.Tx, error) {
...
func (_m *DataStorer) Beginx() (*sqlx.Tx, error) {
	ret := _m.Called()
...
func (_m *DataStorer) BindNamed(query string, arg interface{}) (string, []interface{}, error) {
...
func (_m *DataStorer) Delete(from string) squirrel.DeleteBuilder {
	ret := _m.Called(from)
...
func (_m *DataStorer) DriverName() string {
	ret := _m.Called()
...
func (_m *DataStorer) Get(dest interface{}, query string, args ...interface{}) error {
	var _ca []interface{}
...
func (_m *DataStorer) GetContext(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	var _ca []interface{}
...
func (_m *DataStorer) Insert(into string) squirrel.InsertBuilder {
	ret := _m.Called(into)
...
func (_m *DataStorer) MapperFunc(mf func(string) string) {
	_m.Called(mf)
}

// MustBegin provides a mock function with given fields:
func (_m *DataStorer) MustBegin() *sqlx.Tx {
	ret := _m.Called()
...
func (_m *DataStorer) MustBeginTx(ctx context.Context, opts *sql.TxOptions) *sqlx.Tx {
	ret := _m.Called(ctx, opts)
...
func (_m *DataStorer) MustExec(query string, args ...interface{}) sql.Result {
	var _ca []interface{}
...
func (_m *DataStorer) MustExecContext(ctx context.Context, query string, args ...interface{}) sql.Result {
	var _ca []interface{}
...
func (_m *DataStorer) NamedExec(query string, arg interface{}) (sql.Result, error) {
	ret := _m.Called(query, arg)
...
func (_m *DataStorer) NamedExecContext(ctx context.Context, query string, arg interface{}) (sql.Result, error) {
...
func (_m *DataStorer) NamedQuery(query string, arg interface{}) (*sqlx.Rows, error) {
	ret := _m.Called(query, arg)
...
func (_m *DataStorer) NamedQueryContext(ctx context.Context, query string, arg interface{}) (*sqlx.Rows, error) {
	ret := _m.Called(ctx, query, arg)
...
func (_m *DataStorer) PlaceholderFormat(f squirrel.PlaceholderFormat) squirrel.StatementBuilderType {
	ret := _m.Called(f)
...
func (_m *DataStorer) PrepareNamed(query string) (*sqlx.NamedStmt, error) {
	ret := _m.Called(query)
...
func (_m *DataStorer) PrepareNamedContext(ctx context.Context, query string) (*sqlx.NamedStmt, error) {
...
func (_m *DataStorer) Preparex(query string) (*sqlx.Stmt, error) {
	ret := _m.Called(query)
...
func (_m *DataStorer) PreparexContext(ctx context.Context, query string) (*sqlx.Stmt, error) {
	ret := _m.Called(ctx, query)
...
func (_m *DataStorer) QueryRowx(query string, args ...interface{}) *sqlx.Row {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *DataStorer) QueryRowxContext(ctx context.Context, query string, args ...interface{}) *sqlx.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *DataStorer) Queryx(query string, args ...interface{}) (*sqlx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *DataStorer) QueryxContext(ctx context.Context, query string, args ...interface{}) (*sqlx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *DataStorer) Rebind(query string) string {
	ret := _m.Called(query)
...
func (_m *DataStorer) Replace(into string) squirrel.InsertBuilder {
	ret := _m.Called(into)
...
func (_m *DataStorer) RunWith(runner squirrel.BaseRunner) squirrel.StatementBuilderType {
...
func (_m *DataStorer) Select(columns ...string) squirrel.SelectBuilder {
...
func (_m *DataStorer) SelectContext(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	var _ca []interface{}
	_ca = append(_ca, ctx, dest, query)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *DataStorer) Unsafe() *sqlx.DB {
	ret := _m.Called()
...
func (_m *DataStorer) Update(table string) squirrel.UpdateBuilder {
	ret := _m.Called(table)
