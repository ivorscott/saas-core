...
replace (
	github.com/devpies/saas-core/pkg/web v0.0.0-20220610230130-5f484ffa030f => ./pkg/web
	github.com/devpies/saas-core/pkg/msg v0.0.0-20220610230130-5f484ffa030f => ./pkg/msg
)